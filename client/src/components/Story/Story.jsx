...
const Story = (props) => {
  if (props.story.slides.length === 0) {
    console.error('No slides found for the story:', props.story);
    return null;
  }

  const imageUrl = props.story.slides[0].imageUrl;
  if (!imageUrl) {
    console.error('Invalid image URL for the story:', props.story);
    return null;
  }
